...
from ultralytics.nn.modules import (
    AIFI,SOLA_Bottleneck,C2f_SOLA,SOLAF,SW_Bottleneck,C2f_SW,MSSW,CBAM,CAE, SAE, CSAE,SimAM,EMA, SEBlock,CA, 
    C1,
    C2,
    C2PSA,
    C3,
...
def parse_model(d, ch, verbose=True):
    ...
    base_modules = frozenset(
        {
            Classify,SOLA_Bottleneck,C2f_SOLA,SOLAF,SW_Bottleneck,C2f_SW,MSSW,CAE, SAE, CSAE,
            Conv,
            ConvTranspose,
            GhostConv,
            Bottleneck,
    ...
    repeat_modules = frozenset(  # modules with 'repeat' arguments
        {
            BottleneckCSP,SOLA_Bottleneck,C2f_SOLA,SW_Bottleneck,C2f_SW,MSSW,
            C1,
            C2,
            C2f,
            C3k2,
